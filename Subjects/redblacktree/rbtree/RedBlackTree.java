...
public class RedBlackTree {
    ...
    public void treeInsert2(RedBlackTreeNode x) throws NullPointerException {
        RedBlackTreeNode y = null;
        RedBlackTreeNode z = this.root;
    ...
    public RedBlackTreeNode treeSearch2(RedBlackTreeNode x, int k) {
        if (x == null || k == x.key()) {
            return x;
        }
        if (k < x.key()) {
            return treeSearch2(x.left(), k);
        } else {
            return treeSearch2(x.right(), k);
        }
    }
